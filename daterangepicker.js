...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        hoverDate: function(e) {
            ...
            } else if (!cal.hasClass('left') && !this.container.find('input[name=daterangepicker_end]').is(":focus")) {
        ...
        clickDate: function(e) {
            ...
            if (cal.hasClass('left') || date.isBefore(this.startDate, 'day')) { //picking start
                if (this.timePicker) {
